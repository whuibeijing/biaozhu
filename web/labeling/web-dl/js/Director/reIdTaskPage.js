...
function multi_export(){
	...
	var html="<option value=\"1\" selected=\"\">导出抠图及ReID信息</option>";
	html +="<option value=\"21\">导出标注信息</option>";
	if(userType!=1){
		html +="<option value=\"2\">导出原图及标注</option>";
		html +="<option value=\"3\">导出抠图及ReID信息并以数据集名称重命名</option>";
	}
...
function submit_dataset_reidtask(){
  ...
  reid_task_create(task_name, src_taskid, dest_taskid,assign_user_id, 2,reid_dataset_obj_type,0,labelpropertytaskid);
  page(0,pageSize);
}
...
function submit_auto_reidtask(){
  ...
  reid_task_create(task_name, src_taskid, dest_taskid,assign_user_id, 1,reid_obj_type,reid_auto_type,labelpropertytaskid);
  page(0,pageSize);
...
function reid_task_create(task_name, src_taskid, dest_taskid,assign_user_id,  taskType, reid_obj_type,reid_auto_type=0,labelpropertytaskid){
