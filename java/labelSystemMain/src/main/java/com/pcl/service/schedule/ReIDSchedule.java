...
public class ReIDSchedule {
	...
	private void execReIDTaskNew(ReIDTask reIDTask) {
		...
		try {
			...
			tmpParamMap.put("user_id", dbPolicy.getTableName(reIDTask.getId(), UserConstants.REID_TASK_SINGLE_TABLE, reIDTask.getUser_id()));
					//TokenManager.getUserTablePos(reIDTask.getUser_id(), UserConstants.REID_TASK_SINGLE_TABLE));
	...
	private void updateLabelTaskItemReId(String srcImgName,Map<String,LabelTaskItem> imagesForSrcLabelItemId,int reIDNum,ReIDTask reIDTask) {
		...
		labelTaskItemParamMap.put("user_id",dbPolicy.getTableName(reIDTask.getId(), UserConstants.REID_TASK_SINGLE_TABLE, reIDTask.getUser_id())); 
				//TokenManager.getUserTablePos(reIDTask.getUser_id(), UserConstants.REID_TASK_SINGLE_TABLE));
	...
	public void updateReIdResultToShowResultDB(int userId,String reTaskId) {
		...
		List<LabelTaskItem> itemList = reIdLabelTaskItemDao.queryLabelTaskItemByLabelTaskId(
				dbPolicy.getTableName(reTaskId, UserConstants.REID_TASK_SINGLE_TABLE,userId),reTaskId);
				//TokenManager.getUserTablePos(userId, UserConstants.REID_TASK_SINGLE_TABLE),reTaskId);
