...
public class AutoLabelController {
	...
	public Result autoLabelTask(@RequestBody AutoLabelBody body) throws LabelSystemException {
		
		logger.info("add autoLabelTask, body =" +JsonUtil.toJson(body));
	...
	public Progress queryAutoLabelProgress(@RequestParam("taskId") String taskId) {
		return progressService.queryLabelTask(taskId);
	}
