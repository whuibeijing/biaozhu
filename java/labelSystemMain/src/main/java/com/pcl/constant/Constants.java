...
public class Constants {
	...
	public final static int LABEL_TASK_STATUS_DATASET_DELETED = -1;//数据集被删除了
	
	public final static int LABEL_TASK_STATUS_VERIFY = 1;//审核中
	
	public final static int LABEL_TASK_STATUS_AUTO_LABEL_PROGRESS = 20;//自动标注中
	
	public final static int LABEL_TASK_STATUS_AUTO_LABEL_EXCEPTION = 21;//自动标注异常
	...
	public final static int LABEL_TASK_TYPE_TEXT = 5; 
	...
	public final static int DATASET_TYPE_TEXT = 5; //文本
...
//	public final static int NEED_TO_DISTIGUISH_PERSON_PROPERTY = 2;
	...
	public final static int MODEL_TYPE_AUTO_REGIST = 100;
