...
public class LargePictureTask {
	...
	private String labelPropertyTaskId;
	...
	public String getLabelPropertyTaskId() {
		return labelPropertyTaskId;
	}

	public void setLabelPropertyTaskId(String labelPropertyTaskId) {
		this.labelPropertyTaskId = labelPropertyTaskId;
	}
