...
public class LabelTaskItem {
	...
	public String getPic_real_name() {
		return pic_real_name;
	}

	public void setPic_real_name(String pic_real_name) {
		this.pic_real_name = pic_real_name;
	}
